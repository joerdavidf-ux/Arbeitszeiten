const CACHE_NAME = 'belegsplit-cache-v12';
const ASSETS = [
  './',
  './index.html',
  './style.css',
...
self.addEventListener('fetch', (event) => {
  ...
  // Cache-first for static assets (css/js/icons) and any successfully
  // fetched cross-origin resource (e.g. the OCR library), so it becomes
